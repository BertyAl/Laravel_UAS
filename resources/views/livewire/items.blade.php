...
{{--        Notifikasi Pesan barang telah di add--}}
...
{{--            Tampilan searching--}}
                <div>
                    <input wire:model.debounce.500ms="q"
                           wire:keydown.enter="refreshSearch"
                           type="search"
                           placeholder="Search"
...
{{--        popup penambahan barang dan pengeditan barang--}}
        <x-dialog-modal wire:model="confirmingItemAdd">
            ...
            <x-slot name="content">
                ...
                <div class="col-span-6 sm:col-span-4 mt-4">
                    ...
                    <x-input id="price" type="text" class="mt-1 block w-full" wire:model.defer="item.price" />
